...
\end{equation}
that assigns each element $x \in X$ a value in the interval $[0, 1]$ that represents the degree to which $x$ is a member of the set $\tilde{A}$.
...
In this work we will only consider the standard negation operator and the minimum t-norm and maximum t-conorm as they are the most common choices in practice in fuzzy logic systems.
...
\begin{itemize}
      ...
      \item \textbf{Complement} \\
            ...
            \end{equation}
            This means that the degree of membership of an element $x$ in the complement set $\tilde{C}$ is the complement of the degree of membership of $x$ in the set $\tilde{A}$.
\end{itemize}
...
\begin{align*}
      ...
      \fuzzyset  ::=  & \ \ \fuzzyset \ \text{AND}  \ \fuzzyset             & \text { //Conjunction} \\
                      & |  \ \fuzzyset \ \text{OR} \  \fuzzyset             & \text { //Disjunction} \\
                      & |  \ \text{NOT} \ \fuzzyset                         & \text { //Negation}    \\
                      & |  \ (\; \fuzzyset \;)                              & \text { //Parentheses} \\
