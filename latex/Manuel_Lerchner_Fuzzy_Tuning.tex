...
% PhD Candidate
\def\advisorFst{Manish Kumar Mishra, M.Sc. (hons)}
\def\advisorSnd{Samuel James Newcome, M.Sc.}
\def\date{10.08.2024}
\begin{document}
\frontmatter
% -------------------------------------------------------------------------------
...
\include{content/2TheoreticalBackground}
\include{content/3Implementation}
\include{content/4ProofOfConcept}
\include{content/5ComparisonAndEvaluation}
\include{content/6FutureWork}
