...
/**
 * A class to generate FuzzySets with common membership functions.
 */
class MembershipFunction {
 public:
   ...
   */
  static std::shared_ptr<FuzzySet> makeTriangle(const std::string &linguisticTerm, double min, double mid, double max);
   ...
   */
  static std::shared_ptr<FuzzySet> makeTrapezoid(const std::string &linguisticTerm, double min, double mid1, double mid2, double max);
   ...
   */
  static std::shared_ptr<FuzzySet> makeGaussian(const std::string &linguisticTerm, double mean, double sigma);
};
